...
tiff(paste0(dir,"ext_fig4A_roc_all.tiff"), width = 3.34, height = 3.44, units = 'in', res = 300)
plot_rocs(all_roc_objs, exon = F)
dev.off()

tiff(paste0(dir,"ext_fig4A_roc_intron.tiff"), width = 3.34, height = 3.44, units = 'in', res = 300)
plot_rocs(intron_roc_objs, exon = F)
dev.off()

tiff(paste0(dir,"ext_fig4A_roc_exon.tiff"), width = 3.34, height = 3.44, units = 'in', res = 300)
...
ggsave(paste0(dir, 'fig4B_snv_pr_curves_with_legend', 
              plot_format), 
...
ggsave(paste0("../../figs/snv/ext_fig_6B_pr_curves_type", plot_format), 
