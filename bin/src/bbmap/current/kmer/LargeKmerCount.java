...
public static void main(String[] args){
		...
		if(fileIO.FileFormat.hasFastaExtension(fname1)){
			count=countFasta(fname1, indexbits, cbits, k);
		}else if(fileIO.FileFormat.hasFastqExtension(fname1)){
...
//		System.out.println(Arrays.toString(freq)+"\n");
	...
	public static KCountArray2 countFasta(String fname, int indexbits, int cbits, int k){
...
//		System.out.println("Reset kmer.");
	...
	public static KCountArray2 countFastq(String reads1, String reads2, int indexbits, int cbits, int k){
		...
		FastqReadInputStream fris1=new FastqReadInputStream(reads1, false, false);
		FastqReadInputStream fris2=(reads2==null ? null : new FastqReadInputStream(reads2, false, false));
