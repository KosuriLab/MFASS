...
//		System.out.println(Arrays.toString(freq)+"\n");
	...
	public static KCountArray2 countFastq(String reads1, String reads2, int k, int cbits, boolean rcomp){
		return countFastq(reads1, reads2, k, cbits, rcomp, null);
	}
	
	public static KCountArray2 countFastq(String reads1, String reads2, int k, int cbits, boolean rcomp, KCountArray2 count){
		assert(k>=1 && k<20);
		final int kbits=2*k;
		final long mask=~((-1L)<<(kbits));
